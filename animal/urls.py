...
urlpatterns = [
    ...
    path('project/<int:project_id>/annotation/<int:item_id>/', login_required(views.annotation_page), name='annotation_item_page'),
    path('project/<int:project_id>/screen/', login_required(views.screen_page), name='screen_page'),
    path('project/<int:project_id>/screen/<int:id>/', login_required(views.screen_page), name='screen_item_page'),
